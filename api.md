...
- <code title="get /document-summaries">client.documentSummaries.<a href="./src/resources/document-summaries.ts">list</a>({ ...params }) -> DocumentSummariesCursorPagination</code>
...
- <code title="get /documents">client.documents.<a href="./src/resources/documents.ts">list</a>({ ...params }) -> DocumentsCursorPagination</code>
...
- <code title="get /entities">client.entities.<a href="./src/resources/entities/entities.ts">list</a>({ ...params }) -> EntitiesCursorPagination</code>
...
- <code title="get /households">client.households.<a href="./src/resources/households.ts">list</a>({ ...params }) -> HouseholdsCursorPagination</code>
- <code title="delete /households/{id}">client.households.<a href="./src/resources/households.ts">delete</a>(id) -> void</code>
- <code title="get /households/{id}/documents">client.households.<a href="./src/resources/households.ts">listDocuments</a>(id, { ...params }) -> DocumentsCursorPagination</code>
- <code title="get /households/{id}/entities">client.households.<a href="./src/resources/households.ts">listEntities</a>(id, { ...params }) -> EntitiesCursorPagination</code>
- <code title="get /households/{id}/individuals">client.households.<a href="./src/resources/households.ts">listIndividuals</a>(id, { ...params }) -> IndividualsCursorPagination</code>
...
- <code title="get /individuals">client.individuals.<a href="./src/resources/individuals.ts">list</a>({ ...params }) -> IndividualsCursorPagination</code>
...
- <code title="get /users">client.users.<a href="./src/resources/users.ts">list</a>({ ...params }) -> UsersCursorPagination</code>
